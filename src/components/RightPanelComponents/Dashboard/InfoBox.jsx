const InfoBox = ({
  ...
  return (
    <div
      className={`rounded-lg border w-full h-44 flex flex-col justify-between overflow-hidden border-${color}-300`}
    >
      ...
      <div
        className={`h-8 w-full flex items-center justify-center hover:cursor-pointer hover:scale-110 transition bg-${color}-300`}
